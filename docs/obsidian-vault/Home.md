...
| Metric | Value |
|---|---|
| Version | `v2.0.9` live on `portal.ktcterminal.com` |
| Migrations | **~230 files** (`0001` … `0230`), all applied + tracked (split portal + fuel lanes); `0228` (release-payable + container-cap 200) + `0229` (PO submitted/consignee guards) + `0230` (customer-only self-service guards) applied to prod 2026-06-30 |
