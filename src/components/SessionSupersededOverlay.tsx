...
export default function SessionSupersededOverlay() {
  ...
  return (
    ...
    >
      <div className="ktc-glass" style={{ padding: 32, maxWidth: 420, width: '100%' }}>
        <div style={{ fontSize: 30, marginBottom: 6 }} aria-hidden>📵</div>
        <h1 style={{ margin: 0, fontSize: 20, fontWeight: 650 }}>{t('You’ve been signed out')}</h1>
        <p className="ktc-label" style={{ marginTop: 10, fontSize: 13.5, lineHeight: 1.6 }}>
          {t('This account was just signed in on another device or browser, so this session was ended. Only one device can be signed in at a time. If this wasn’t you, sign in again and change your password.')}
        </p>
